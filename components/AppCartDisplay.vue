      ...
      <section class="payment">
        ...
        <div class="total">
          <div class="caption">
            ...
            <p>Delivered to home: <input type="checkbox" @click="selectDelivery($event)" v-bind="deliverySelected" >                       
</p> <p>Pickup at farm:</p>
...
export default {
  ...
  methods: {
    ...
    if (event.target.checked) {
      // alert('isSelected');
      this.$store.commit("selectDelivery");
    } else {
              this.$store.commit("noDelivery");
    }
}
  }
};
